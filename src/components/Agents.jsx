...
import agent5 from "../assets/home2person5.png";
import agent6 from "../assets/home2person1.jpg";
import agent7 from "../assets/home-2-person.png";
import agent8 from "../assets/home3person1.png";
        ...
        <>
            ...
            <div className="agnt-wrapper py-5">
                <div className="container">
                    ...
                    <h2 className="agnt-title mb-4">Agents</h2>

                    <div className="row g-3 mb-5">
                        <div className="col-lg-3 col-md-6">
                            <input
                                type="text"
                                className="form-control agnt-search-input"
                        ...
                        <div className="col-lg-3 col-md-6">
                            <select className="form-select agnt-select">
                                <option>All agency</option>
                    ...
                    <div className="row g-4">
                        {agentsData.map((agent) => (
                            <div key={agent.id} className="col-lg-3 col-md-6">
                                <div className="agnt-card">
                                    <div className="agnt-img-wrapper">
                                        <img src={agent.img} alt="agent" />

                                        <div className="agnt-hover-icons">
                                    ...
                                    <div className="agnt-content">
                                        ...
                                        <div className="agnt-contact-icons">
            ...
            <div className="container pp-wrapper d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div className="pp-info-text">
                    1 – 20 of <span>250+</span> property available
                </div>
