...
export default function AgenciesList() {
    const agencieslist = [
        {
            ...
            desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ligula neque, ornare quis urna nec, congue hendrerit turpis.",
            logo: logo1,
        },
        {
            id: 2,
    ...
    return (
        <>
            ...
            <section className="aglist-wrapper">
                <div className="container">
                    <div className="row">
                        {/* LEFT SIDE */}
                        <div className="col-lg-8">
                            <div className="aglist-header">
                                <h2>Agencies</h2>

                                <div className="aglist-actions">
                                    <button className="aglist-view-btn">
                                        <i className="fas fa-th"></i>
                                    </button>
                                    <button className="aglist-view-btn active">
                                        <i className="fas fa-bars"></i>
                                    </button>

                                    <select className="aglist-sort">
                            ...
                            {agencieslist.map((item) => (
                                <div className="aglist-card" key={item.id}>
                                    <div className="aglist-logo">
                                        <img src={item.logo} alt="logo" />
                                    </div>

                                    <div className="aglist-content">
                                        <h5>{item.name}</h5>

                                        <p className="aglist-address">
                                            <i className="fas fa-map-marker-alt"></i>
                                            {item.address}
                                        </p>

                                        <p className="aglist-desc">{item.desc}</p>

                                        <div className="aglist-footer">
                                            <div className="aglist-icons">
                                                <span><i className="fas fa-phone"></i></span>
                                                <span><i className="fas fa-envelope"></i></span>
                                                <span><i className="fas fa-globe"></i></span>
                                            </div>

                                            <button className="aglist-details-btn">Details</button>
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="col-lg-4">
                            <div className="aglist-contact-box">
                                <h4>Contact Me</h4>
                                ...
                                <div className="aglist-contact-btns">
                                    <button className="aglist-send-btn">
                                        <i className="fas fa-envelope"></i> Send message
                                    </button>
                                    <button className="aglist-call-btn">
