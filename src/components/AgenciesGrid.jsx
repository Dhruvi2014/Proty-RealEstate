...
import img1 from "../assets/box-house1.jpg";
import img2 from "../assets/box-house2.jpg";
import img3 from "../assets/box-house3.jpg";
import img4 from "../assets/box-house4.jpg";
import img5 from "../assets/box-house5.jpg";
import img6 from "../assets/box-house6.jpg";
import img7 from "../assets/blog-grid-1.jpg";
import img8 from "../assets/blog-grid-3.jpg";

import logo1 from "../assets/brand1.jpg";
import logo2 from "../assets/brand2.jpg";
import logo3 from "../assets/brand3.jpg";
import logo4 from "../assets/brand4.jpg";
import logo5 from "../assets/brand5.jpg";
import logo6 from "../assets/brand6.jpg";
import logo7 from "../assets/brand7.jpg";
import logo8 from "../assets/brand8.jpg";
...
export default function AgenciesGrid() {
    const agenciesData = [
        { name: "Lorem House", img: img1, logo: logo1 },
        { name: "Urban Estate", img: img2, logo: logo2 },
        { name: "Prime Realty", img: img3, logo: logo3 },
        { name: "Modern Living", img: img4, logo: logo4 },
        { name: "Elite Homes", img: img5, logo: logo5 },
        { name: "Golden Key", img: img6, logo: logo6 },
        { name: "Dream Properties", img: img7, logo: logo7 },
        { name: "Smart Realty", img: img8, logo: logo8 },
    ];
    return (
        <>
            ...
            <section className="ag-main-wrapper">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-8">
                            <div className="ag-header">
                                ...
                                <div className="ag-actions">
                                    <button className="ag-view-btn active">
                            ...
                            <div className="row g-4">
                                {agenciesData.map((item, index) => (
                                    <div className="col-md-6" key={index}>
                                        <div className="ag-card-box">

                                            <div className="ag-img-box">
                                            ...
                                            <div className="ag-content">
                                                ...
                                                <ul>
                                                    <li><strong>Listing:</strong> 7,328</li>
                                                    <li><strong>Hotline:</strong> +7-445-556-8337</li>
                                                    <li><strong>Phone:</strong> +7-445-556-8337</li>
                                                    <li><strong>Email:</strong> loremhouse@gmail.com</li>
                                                </ul>
